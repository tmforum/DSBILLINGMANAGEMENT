...
@Stateless
@Asynchronous
public class AppliedCustomerBillingChargeRESTEventPublisher implements AppliedCustomerBillingChargeRESTEventPublisherLocal {
    ...
    public void publish(Hub hub, AppliedCustomerBillingChargeEvent event) {
        ...
        List<AppliedCustomerBillingChargeEvent> resultList = null;
        resultList = eventFacade.findByCriteria(query, AppliedCustomerBillingChargeEvent.class);
