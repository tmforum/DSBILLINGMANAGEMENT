...
@Stateless
@Asynchronous
public class SettlementNoteAdviceRESTEventPublisher implements SettlementNoteAdviceRESTEventPublisherLocal {
    ...
    public void publish(Hub hub, SettlementNoteAdviceEvent event) {
        ...
        List<SettlementNoteAdviceEvent> resultList = null;
        resultList = eventFacade.findByCriteria(query, SettlementNoteAdviceEvent.class);
