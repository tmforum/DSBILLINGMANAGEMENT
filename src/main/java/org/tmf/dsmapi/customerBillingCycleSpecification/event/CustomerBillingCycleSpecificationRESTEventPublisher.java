...
@Stateless
@Asynchronous
public class CustomerBillingCycleSpecificationRESTEventPublisher implements CustomerBillingCycleSpecificationRESTEventPublisherLocal {
    ...
    public void publish(Hub hub, CustomerBillingCycleSpecificationEvent event) {
        ...
        List<CustomerBillingCycleSpecificationEvent> resultList = null;
        resultList = eventFacade.findByCriteria(query, CustomerBillingCycleSpecificationEvent.class);
