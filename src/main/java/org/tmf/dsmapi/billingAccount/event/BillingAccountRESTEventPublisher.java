...
@Stateless
@Asynchronous
public class BillingAccountRESTEventPublisher implements BillingAccountRESTEventPublisherLocal {
    ...
    public void publish(Hub hub, BillingAccountEvent event) {
        ...
        List<BillingAccountEvent> resultList = null;
        resultList = eventFacade.findByCriteria(query, BillingAccountEvent.class);
