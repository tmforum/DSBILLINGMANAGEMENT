...
@Stateless
@Asynchronous
public class CustomerBillPresentationMediaRESTEventPublisher implements CustomerBillPresentationMediaRESTEventPublisherLocal {
    ...
    public void publish(Hub hub, CustomerBillPresentationMediaEvent event) {
        ...
        List<CustomerBillPresentationMediaEvent> resultList = null;
        resultList = eventFacade.findByCriteria(query, CustomerBillPresentationMediaEvent.class);
